-- ##########################################################################
--  SCRIPT MAP | function allocation index
--  every function, where it lives, and what it belongs to
--  generated by the rename/cleanup pass - keep in sync with the code
-- ##########################################################################
